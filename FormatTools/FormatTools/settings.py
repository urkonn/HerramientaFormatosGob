...
BROKER_URL = 'redis://172.17.0.3:6379' # 'redis://{0}:{1}'.format(REDIS_TCP_ADDR_TASK, REDIS_TCP_PORT_TAKS)
CELERY_RESULT_BACKEND = 'redis://172.17.0.4:6379'  # 'redis://{0}:{1}'.format(REDIS_TCP_ADDR_RESPONSE, REDIS_TCP_PORT_RESPONSE)
